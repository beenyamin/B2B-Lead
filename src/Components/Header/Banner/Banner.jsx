        ...
        <div className="inset-0 bg-cover min-h-screen"
            ...
            <div className="container mx-auto pt-28">
                ...
                <div className="text-center pt-8 lg:pt-24">
                    <p className="lg:text-5xl text-2xl lg:font-semibold font-bold text-white">Find Your Highly Targeted Verified <br /> <span className=''>Lead For Only 30¢</span></p>
                    <p className=" lg:py-5 lg:text-xl text-sm text-white mt-4">Using your search criteria, we find and build highly targeted lists in 48 hrs. <br/> fill your pipeline with high-quality  human-verified leads at an affordable <br /> way.!</p>
            ...
            <div className='text-white pb-20 text-center justify-center max-auto mt-6 flex flex-col lg:flex-row space-y-5 lg:space-x-20 '>
                <div className=''>
                    <h2 className='lg:text-3xl text-xl lg:mt-5 font-semibold lg:font-semibold'>20k </h2>
                    <h2 className='lg:text-xl lg:mt-2'>Lead Each Week </h2>
                </div>
                <div className=''>
                    <h2 className='lg:text-3xl text-xl font-medium lg:font-bold'>3 Years </h2>
