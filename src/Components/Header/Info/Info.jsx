...
const Info = () => {
      return (
            <div>
                  <div className='bg-rose-400 hidden lg:block'>
                              ...
                              <div className='flex space-x-2 mr-6 '>
                                    <Link>
                                          ...
                                          <div className="flex ml-">
                                                <div className="pt-1 ml-8">  <IoLogoWhatsapp size={20} /></div>
                                                <div className="pt-1 ml-8">  <FaLinkedin size={20} /></div>
                                                <div className="pt-1 ml-8">  <FaFacebookSquare size={20} /></div>
                                          </div>
